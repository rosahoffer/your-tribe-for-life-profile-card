...
const stacktrace = require("../../utils/esm/stacktrace.cjs");
const hub = require("../../core/esm/hub.cjs");
const _optionalChain = require("../../utils/esm/buildPolyfills/_optionalChain.cjs");
const integration = require("../../core/esm/integration.cjs");
const sdk = require("../../core/esm/sdk.cjs");
const worldwide = require("../../utils/esm/worldwide.cjs");
const inboundfilters = require("../../core/esm/integrations/inboundfilters.cjs");
const functiontostring = require("../../core/esm/integrations/functiontostring.cjs");
...
function init(options = {}) {
  ...
  if (domain__namespace.active) {
    hub.setHubOnCarrier(carrier, hub.getCurrentHub());
  }
  const clientOptions = {
    ...options,
  ...
  sdk.initAndBind(client.NodeClient, clientOptions);
...
const defaultStackParser = stacktrace.createStackParser(stacktrace.nodeStackLineParser(module$1.getModule));
function startSessionTracking() {
  const hub$1 = hub.getCurrentHub();
  hub$1.startSession();
  process.on("beforeExit", () => {
    const session = _optionalChain._optionalChain([hub$1, "access", (_3) => _3.getScope, "call", (_4) => _4(), "optionalAccess", (_5) => _5.getSession, "call", (_6) => _6()]);
