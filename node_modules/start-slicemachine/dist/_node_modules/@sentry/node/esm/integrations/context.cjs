...
class Context {
  ...
  _updateContext(contexts) {
    if (_optionalChain._optionalChain([contexts, "optionalAccess", (_9) => _9.app, "optionalAccess", (_10) => _10.app_memory])) {
      contexts.app.app_memory = process.memoryUsage().rss;
    }
    if (_optionalChain._optionalChain([contexts, "optionalAccess", (_11) => _11.device, "optionalAccess", (_12) => _12.free_memory])) {
...
function getDeviceContext(deviceOpt) {
  const device = {};
  const uptime = os__namespace.uptime && os__namespace.uptime();
