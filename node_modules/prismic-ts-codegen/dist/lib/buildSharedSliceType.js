...
import { SHARED_SLICES_DOCUMENTATION_URL } from "../constants.js";
  ...
  for (const variationModel of args.model.variations) {
    ...
    if (variationModel.primary && Object.keys(variationModel.primary).length > 0) {
      ...
      const docs = stripIndent`
				 ...
				 */
			`;
      code = addSection(primaryFieldProperties.code ? source`
						${docs}
    ...
    if (variationModel.items && Object.keys(variationModel.items).length > 0) {
      ...
      const docs = stripIndent`
				 ...
				 */
			`;
      code = addSection(itemFieldProperties.code ? source`
						${docs}
...
export {
  buildSharedSliceType
};
//# sourceMappingURL=buildSharedSliceType.js.map
