...
class Client {
  ...
  async fetch(url, params = {}) {
    ...
    switch (res.status) {
      ...
      case 401:
      case 403: {
        throw new ForbiddenError.ForbiddenError("error" in res.json ? res.json.error : res.json.message, url, res.json);
      }
      case 404: {
