...
var serializeImage = (linkResolver, node) => {
  ...
  if (node.linkTo) {
    imageTag = serializeHyperlink(linkResolver, {
      type: RichTextNodeType2.hyperlink,
      data: node.linkTo,
      start: 0,
      end: 0
    }, [imageTag]);
...
var createDefaultHTMLRichTextSerializer = (linkResolver) => {
...
// node_modules/@prismicio/client/dist/helpers/unstable_mapSliceZone.js
function unstable_mapSliceZone(sliceZone2, mappers, context) {
...
export {
  ...
  asLinkAttrs,
  asText2 as asText,
  RichTextNodeType2 as RichTextNodeType,
  asHTML,
  asImageSrc,
  asImageWidthSrcSet,
...
//# sourceMappingURL=chunk-AP3FVX3M.js.map
