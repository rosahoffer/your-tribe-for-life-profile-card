...
const ProjectManager = require("./project/ProjectManager.cjs");
const CustomTypesManager = require("./customTypes/CustomTypesManager.cjs");
const SlicesManager = require("./slices/SlicesManager.cjs");
const SnippetsManager = require("./snippets/SnippetsManager.cjs");
const ScreenshotsManager = require("./screenshots/ScreenshotsManager.cjs");
...
class SliceMachineManager {
  constructor(args) {
    ...
    this.plugins = new PluginsManager.PluginsManager(this, {
      nativePlugins: args == null ? void 0 : args.nativePlugins
    });
    this.project = new ProjectManager.ProjectManager(this);
    this.customTypes = new CustomTypesManager.CustomTypesManager(this);
    this.slices = new SlicesManager.SlicesManager(this);
    this.snippets = new SnippetsManager.SnippetsManager(this);
...
exports.SliceMachineManager = SliceMachineManager;
//# sourceMappingURL=SliceMachineManager.cjs.map
