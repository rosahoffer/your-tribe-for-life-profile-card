  ...
  switch (process.env.SM_ENV) {
    case APPLICATION_MODE.Development: {
      ...
      if (missingAPIEndpoints.length > 0) {
        console.error(`You are running Slice Machine in development mode where API endpoints are configured via environment variables. The following endpoints were not configured: ${missingAPIEndpoints.join(", ")}. Configure them before continuing.`);
        process.exit(1);
      }
      return apiEndpoints;
    }
