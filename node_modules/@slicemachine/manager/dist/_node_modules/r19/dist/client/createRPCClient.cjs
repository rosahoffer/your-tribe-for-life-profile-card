...
const isPlainObject = require("../lib/isPlainObject.cjs");
...
const createRPCClient = (args) => {
  ...
  return createArbitrarilyNestedFunction(async (procedurePath, fnArgs) => {
    ...
    if (procedureArgs !== void 0 && !isPlainObject.isPlainObject(procedureArgs)) {
      throw new R19Error.R19Error("r19 only supports a single object procedure argument, but something else was provided.", {
        procedurePath,
        procedureArgs
      });
    }
