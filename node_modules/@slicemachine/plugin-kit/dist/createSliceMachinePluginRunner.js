...
import { createSliceMachineContext } from "./createSliceMachineContext.js";
import { createSliceMachineHookSystem } from "./createSliceMachineHookSystem.js";
import { createSliceMachineActions } from "./createSliceMachineActions.js";
import { createSliceMachineHelpers } from "./createSliceMachineHelpers.js";
...
class SliceMachinePluginRunner {
  constructor({ project, hookSystem, nativePlugins = {} }) {
    ...
    this.rawActions = createSliceMachineActions(this._project, this._hookSystem);
  ...
  async _loadPlugin(pluginRegistration) {
    ...
    if (typeof resolve === "string") {
      try {
        const raw = await createRequire(path.resolve(this._project.root, "noop.js"))(resolve);
...
//# sourceMappingURL=createSliceMachinePluginRunner.js.map
