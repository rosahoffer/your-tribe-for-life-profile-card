 ...
 */
export type SliceMachineConfigPluginRegistration<TPluginOptions extends SliceMachinePluginOptions = SliceMachinePluginOptions> = string | SliceMachinePlugin | {
 ...
 * A hook handler.
 */
export type SliceMachineHook<TData, TReturn> = (data: TData) => Promisable<TReturn>;
/**
 * Extra arguments provided to hooks when called.
 *
 * @typeParam TPluginOptions - User-provided options for the hook's plugin.
 */
export type SliceMachineHookExtraArgs<TPluginOptions extends SliceMachinePluginOptions = SliceMachinePluginOptions> = [context: SliceMachineContext<TPluginOptions>];
/**
 ...
 * @typeParam TPluginOptions - User-provided options for the hook's plugin.
 */
export type ExtendSliceMachineHook<THook extends SliceMachineHook<any, any>, TPluginOptions extends SliceMachinePluginOptions = SliceMachinePluginOptions> = (...args: [
 ...
 * Hook types.
 */
export declare const SliceMachineHookType: {
    ...
    readonly slice_asset_update: "slice:asset:update";
    ...
    readonly customType_asset_delete: "custom-type:asset:delete";
    readonly customType_asset_read: "custom-type:asset:read";
 ...
 * Hook types.
 */
export type SliceMachineHookTypes = (typeof SliceMachineHookType)[keyof typeof SliceMachineHookType];
/**
