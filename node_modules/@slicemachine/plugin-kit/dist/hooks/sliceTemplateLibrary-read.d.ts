 ...
 * @internal
 */
export type SliceTemplateLibraryReadHookBase = SliceMachineHook<SliceTemplateLibraryReadHookData, SliceTemplateLibraryReadHookReturnType>;
/**
 * Handler for the `slice-template-library:read` hook.
 *
 * @typeParam TPluginOptions - User-provided options for the hook's plugin.
 */
export type SliceTemplateLibraryReadHook<TPluginOptions extends SliceMachinePluginOptions = SliceMachinePluginOptions> = ExtendSliceMachineHook<SliceTemplateLibraryReadHookBase, TPluginOptions>;
