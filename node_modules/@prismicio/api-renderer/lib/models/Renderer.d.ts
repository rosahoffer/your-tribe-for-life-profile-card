...
import type { DocumentLink, ExternalLink, FileLink, ImageLink } from "@prismicio/types-internal/lib/documents/widgets/nestable/Link";
...
export interface LinkRenderer<D extends MediaLinkDef | DocumentLinkDef | WebLinkDef, C extends DocumentLink | FileLink | ExternalLink | ImageLink, F extends Field | undefined = undefined> {
    renderV1(content: C, fetch?: F | undefined): unknown;
