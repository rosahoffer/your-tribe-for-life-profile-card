...
const StructuredTextContent_1 = require("@prismicio/types-internal/lib/documents/widgets/nestable/StructuredTextContent");
...
function renderSummaryJson(text, renderer) {
    ...
    return renderer({
        __TYPE__: StructuredTextContent_1.StructuredTextContentType,
        value: firstBlock,
    });
}
