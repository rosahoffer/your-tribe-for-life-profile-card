...
const SimpleSliceRenderer = (ctx) => ({
    renderV1(content, fetch) {
        if (content.__TYPE__ === EmptyContent_1.EmptyContentType) {
            return O.none;
        }
        return O.some({
    ...
    renderV2(def, content, fetch) {
        ...
        return O.some({
            value: (0, StaticWidgetRenderer_1.default)(ctx).renderV2(def.widget, content, fetch),
        });
    },
    renderDefault(_def) {
        return {};
    ...
    renderMocks(def, content) {
        ...
        return O.some({
            value: (0, StaticWidgetRenderer_1.default)(ctx).renderMocks(def.widget, content),
        });
    },
});
