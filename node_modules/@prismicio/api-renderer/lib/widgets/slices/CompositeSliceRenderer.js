...
const CompositeSliceRenderer = (ctx) => ({
    ...
    renderV2(def, content, fetch) {
        ...
        const primaryValue = (0, SimpleWidgetRenderer_1.default)(ctx).renderObjectOfSimpleWidgetV2(content.nonRepeat, nonRepeatFetch, def.primary, {
            withFetch: "default",
        }, {
            default: "render",
            withFetch: "filter",
    ...
    renderMocks(def, content) {
        const itemsValue = content.repeat.map((items) => {
            return (0, SimpleWidgetRenderer_1.default)(ctx).renderObjectOfSimpleWidgetMocks(items.value, def.items.fields);
        });
        const primaryValue = (0, SimpleWidgetRenderer_1.default)(ctx).renderObjectOfSimpleWidgetMocks(content.nonRepeat, def.primary);
        return {
            primary: primaryValue,
            items: itemsValue,
        };
