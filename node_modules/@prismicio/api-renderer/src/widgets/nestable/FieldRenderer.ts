...
const FieldRenderer: Renderer<FieldDefO, FieldContent> = {
	...
	renderV2(_def: FieldDefO, content: FieldContent): unknown {
		switch (content.type) {
			case "Number":
	...
	renderDefault(_def: FieldDefO): unknown {
		return null
	},

	renderMocks(def: FieldDefO, content: FieldContent): unknown {
