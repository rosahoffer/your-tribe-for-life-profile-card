...
export type Patch = {
	diff: DiffChange<NestableWidget, NestableWidget>
	content?: NestableContent | undefined
	config?: NestableWidgetMockConfig | undefined
}
export interface WidgetMockWithDiff<
	D extends DynamicWidget,
	W extends WidgetContent,
	C extends
		| MockConfig<Exclude<FieldType, DynamicSlices["type"]>, unknown>
		| undefined = undefined,
> {
	generate(def: D, config?: C): W
	patch(
		diff: DiffChange<unknown, unknown>,
		content?: W,
		config?: C,
	): W | undefined
}

export interface NestableMock<
	D extends DynamicWidget,
	W extends WidgetContent,
	C extends
		| MockConfig<Exclude<FieldType, DynamicSlices["type"]>, unknown>
		| undefined = undefined,
> extends WidgetMockWithDiff<D, W, C> {
	generate(def: D, config?: C): W
	patch(
		diff: DiffChange<unknown, unknown>,
		content?: W,
...
export interface WidgetMock<
	...
	W extends WidgetContent,
	C extends
		| MockConfig<Exclude<FieldType, typeof DynamicSlices["type"]>, unknown>
		| undefined = undefined,
> {
	generate(def: D, config?: C): W
}

export interface SlicesMock<
	D extends DynamicWidget,
	W extends WidgetContent,
	C extends MockConfig<DynamicSlices["type"], unknown> | undefined = undefined,
> {
	generate(
		def: D,
...
export interface SliceMock<
	D extends StaticSlice,
	S extends SharedSliceContent,
	C extends MockConfig<SlicesTypes, unknown> | undefined = undefined,
> {
	...
	patch(
		...
		content?: S,
		config?: C,
	): { ok: true; result: S | undefined } | { ok: false; error: Error }
}
