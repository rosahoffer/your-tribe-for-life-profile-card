...
const images = images_json_1.default;
...
function generateImageView(img) {
    ...
    const [originUrl, originWidth, originHeight] = (() => {
        const randomImage = images[(0, utils_1.randomInt)(0, images.length - 1)];
        const generatedUrl = randomImage === null || randomImage === void 0 ? void 0 : randomImage.raw.split("?")[0];
        if (!generatedUrl)
